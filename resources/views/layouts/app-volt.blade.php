...
<!-- Primary Meta Tags -->
<title>Ketewel GIS - Sign in page</title>
...
<!-- Favicon -->
<link rel="apple-touch-icon" sizes="120x120" href="{{ asset('images/sedang_1655190484_logo_desa-removebg-preview.png') }}">
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('images/sedang_1655190484_logo_desa-removebg-preview.png') }}">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('images/sedang_1655190484_logo_desa-removebg-preview.png') }}">
<link rel="manifest" href="{{ asset('images/sedang_1655190484_logo_desa-removebg-preview.png') }}">
<link rel="mask-icon" href="{{ asset('images/sedang_1655190484_logo_desa-removebg-preview.png') }}" color="#ffffff">
