                        ...
                        <form action="{{ route('spot.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <select name="centre_point_id" id="centre_point_id" class="form-control @error('centre_point_id') is-invalid @enderror" onchange="updateMapCenter(this)">
                                    <option value="">Pilih Centre Point</option>
                                     @foreach($centerPoints as $center)
                                         <option value="{{ $center->id }}" data-coordinates="{{ $center->coordinates }}">{{ $center->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group my-3">
                                ...
                                <input type="number" class="form-control @error('jumlah_anggota_kk')
                                    is-invalid
                                @enderror" name="jumlah_anggota_kk">
                            ...
                            <div class="form-group my-3">
                                ...
                                <input type="text" class="form-control @error('kontaknowa')
                                    is-invalid
                                @enderror" name="kontaknowa">
                                @error('kontaknowa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
